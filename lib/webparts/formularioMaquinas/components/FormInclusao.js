...
export default function FormInclusao(_a) {
    ...
    var updateTransfer = function (field, value) {
        return setFormData(function (p) {
            var _a;
            return (__assign(__assign({}, p), { transferData: __assign(__assign({}, p.transferData), (_a = {}, _a[field] = value, _a)) }));
        });
    };
    var updateUser = function (i, field, value) {
        var _a;
        var arr = __spreadArray([], formData.users, true);
        arr[i] = __assign(__assign({}, arr[i]), (_a = {}, _a[field] = value, _a));
        setFormData(function (p) { return (__assign(__assign({}, p), { users: arr })); });
    };
    var addUser = function () { return setFormData(function (p) { return (__assign(__assign({}, p), { users: __spreadArray(__spreadArray([], p.users, true), [{ name: '', email: '', department: '' }], false) })); }); };
    var removeUser = function (i) {
        if (formData.users.length === 1)
            return;
        setFormData(function (p) { return (__assign(__assign({}, p), { users: p.users.filter(function (_, idx) { return idx !== i; }) })); });
    };
    var validate = function (s) {
        ...
        if (s === 3)
            return formData.users.every(function (u) { return u.name.trim() && u.email.trim() && isValidEmail(u.email) && u.department.trim(); });
        if (s === 4)
                ...
                React.createElement("div", { style: S.cardBody },
                        ...
                        formData.users.map(function (u, i) { return (React.createElement("div", { key: i, style: S.itemCard },
                            React.createElement("div", { style: S.itemCardHeader },
                                React.createElement("span", null,
                                    "\uD83D\uDCBB M\u00E1quina ",
                                    i + 1),
                                formData.users.length > 1 && (React.createElement("button", { onClick: function () { return removeUser(i); }, style: __assign(__assign({}, S.iconBtn), { color: '#ef4444' }), title: "Remover" }, "\uD83D\uDDD1"))),
                            React.createElement("div", { style: S.itemCardBody },
                                React.createElement("div", { style: __assign(__assign({}, S.group), { marginBottom: '12px' }) },
                                    React.createElement("label", { style: S.label },
                                ...
                                React.createElement("div", { style: S.grid2 },
                                    React.createElement("div", null,
                                        React.createElement("label", { style: S.label },
                                            "E-mail ",
                                            React.createElement("span", { style: { color: '#ef4444' } }, "*")),
                                        React.createElement("input", { style: __assign(__assign({}, S.input), { borderColor: showError && u.email.trim() && !isValidEmail(u.email) ? '#ef4444' : undefined }), type: "email", placeholder: "joao@empresa.com.br", value: u.email, onChange: function (e) { return updateUser(i, 'email', e.target.value); }, onFocus: inputFocus, onBlur: inputBlur }),
                                        showError && u.email.trim() && !isValidEmail(u.email) && (React.createElement("span", { style: { fontSize: '12px', color: '#ef4444', marginTop: '4px', display: 'block' } }, "E-mail inv\u00E1lido."))),
                                    React.createElement("div", null,
                                        React.createElement("label", { style: S.label },
                                            "Departamento ",
                                            React.createElement("span", { style: { color: '#ef4444' } }, "*")),
                    ...
                    step === 4 && (React.createElement("div", null,
                        ...
                        React.createElement("div", { style: S.group },
                            React.createElement("label", { style: S.label },
                                ...
                                React.createElement("span", { style: { color: '#ef4444' } }, "*")),
                            React.createElement("textarea", { style: __assign(__assign({}, S.textarea), { minHeight: '60px' }), rows: 2, placeholder: "Ex: Servidor Z: // P\u00FAblico / Departamento Pessoal / OneDrive Geral", value: formData.folders, onChange: function (e) { return update('folders', e.target.value); }, onFocus: inputFocus, onBlur: inputBlur })),
                        React.createElement("div", { style: S.grid2 },
                            React.createElement("div", { style: S.group },
                                React.createElement("label", { style: S.label },
                                    "ID Team Viewer ",
                        ...
                        React.createElement("div", { style: S.group },
                            React.createElement("label", { style: S.label },
                                ...
                                React.createElement("span", { style: { color: '#ef4444' } }, "*")),
                            React.createElement("textarea", { style: __assign(__assign({}, S.textarea), { minHeight: '60px' }), rows: 2, placeholder: "Ex: Pacote Office, Emissor de NF, Certificados Digitais...", value: formData.programs, onChange: function (e) { return update('programs', e.target.value); }, onFocus: inputFocus, onBlur: inputBlur })),
                        React.createElement("div", { style: S.group },
                        ...
                        React.createElement("div", { style: __assign(__assign({}, S.group), { background: theme.primaryLight, border: "1px solid ".concat(theme.primaryLighter), borderRadius: '10px', padding: '1rem' }) },
                            React.createElement("label", { style: __assign(__assign({}, S.label), { color: '#1e3a8a' }) },
                                "Login de refer\u00EAncia ",
                                React.createElement("span", { style: { color: '#ef4444' } }, "*")),
                            ...
                            React.createElement("span", { style: __assign(__assign({}, S.helpText), { color: '#1e40af', textTransform: 'uppercase', fontWeight: 600, letterSpacing: '0.3px' }) }, "Login de um colaborador no mesmo departamento para c\u00F3pia de permiss\u00F5es.")))),
                    step === 5 && (React.createElement("div", null,
                        ...
                        React.createElement("div", { style: { background: '#fff', border: '1px solid #e2e8f0', borderRadius: '10px', padding: '1.25rem', marginBottom: '1.25rem' } },
                            React.createElement("label", { style: __assign(__assign({}, S.label), { marginBottom: '1rem' }) }, "Haver\u00E1 transfer\u00EAncia de arquivos ou configura\u00E7\u00F5es de uma m\u00E1quina antiga?"),
                        ...
                        formData.needsTransfer && (React.createElement("div", { style: { background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '10px', padding: '1.25rem' } },
                            ...
                            React.createElement("div", { style: S.group },
                                ...
                                React.createElement("textarea", { style: __assign(__assign({}, S.textarea), { minHeight: '56px' }), rows: 2, placeholder: "Ex: C:\\Sistemas\\NFe, Meus Documentos...", value: formData.transferData.filesToTransfer, onChange: function (e) { return updateTransfer('filesToTransfer', e.target.value); }, onFocus: inputFocus, onBlur: inputBlur })),
                            React.createElement("div", { style: S.group },
                                React.createElement("label", { style: S.label }, "Configura\u00E7\u00F5es de Softwares"),
                                React.createElement("textarea", { style: __assign(__assign({}, S.textarea), { minHeight: '56px' }), rows: 2, placeholder: "Ex: Token banc\u00E1rio, Senhas do sistema ERP...", value: formData.transferData.programsToTransfer, onChange: function (e) { return updateTransfer('programsToTransfer', e.target.value); }, onFocus: inputFocus, onBlur: inputBlur })),
                            React.createElement("label", { style: __assign(__assign({}, S.label), { marginBottom: '8px' }) }, "Itens Comuns:"),
                    ...
                    step === 6 && (React.createElement("div", null,
                        React.createElement("div", { style: { textAlign: 'center', marginBottom: '2rem' } },
                            ...
                            React.createElement("p", { style: __assign(__assign({}, S.sectionTitle), { textAlign: 'center' }) }, "Tudo pronto para enviar!"),
                        ...
                        React.createElement("div", { style: S.reviewBox },
                            ...
                            React.createElement("div", { style: { padding: '1rem 1.25rem', borderBottom: '1px solid #f1f5f9' } },
                                ...
                                React.createElement("span", { style: __assign(__assign({}, S.reviewValue), { fontSize: '20px', color: theme.primary }) }, formData.users.length)),
