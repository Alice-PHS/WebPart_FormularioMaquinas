...
export default function FormNovoUsuario(_a) {
    ...
    var validate = function (s) {
        ...
        if (s === 3)
            return (formData.userNames.trim() && formData.emails.trim() && isValidEmailList(formData.emails) && formData.departments.trim() &&
            ...
            React.createElement("div", { style: S.card },
                React.createElement("div", { style: S.cardBody },
                    step === 1 && (React.createElement("div", null,
                        React.createElement("div", { style: __assign(__assign({}, S.alertBox), { borderLeftColor: theme.primary, background: theme.primaryLight }) },
                            React.createElement("span", { style: { fontSize: '22px', flexShrink: 0 } }, "\u2139\uFE0F"),
                            React.createElement("div", null,
                                React.createElement("p", { style: __assign(__assign({}, S.alertTitle), { color: '#581c87' }) }, "Sobre esta solicita\u00E7\u00E3o"),
                                React.createElement("p", { style: __assign(__assign({}, S.alertText), { color: '#6b21a8' }) },
                    ...
                    step === 3 && (React.createElement("div", null,
                        ...
                        React.createElement("div", { style: S.group },
                            React.createElement("label", { style: S.label },
                                ...
                                React.createElement("span", { style: { color: '#ef4444' } }, "*")),
                            React.createElement("textarea", { style: __assign(__assign({}, S.textarea), { minHeight: '56px' }), rows: 2, placeholder: "Insira o(s) nome(s) completo(s)", value: formData.userNames, onChange: function (e) { return update('userNames', e.target.value); }, onFocus: inputFocus, onBlur: inputBlur })),
                        React.createElement("div", { style: S.group },
                            React.createElement("label", { style: S.label },
                                "E-mail(s) ",
                                React.createElement("span", { style: { color: '#ef4444' } }, "*")),
                            React.createElement("textarea", { style: __assign(__assign({}, S.textarea), { minHeight: '56px', borderColor: showError && formData.emails.trim() && !isValidEmailList(formData.emails) ? '#ef4444' : undefined }), rows: 2, placeholder: "Insira o(s) e-mail(s), separados por v\u00EDrgula caso haja mais de um", value: formData.emails, onChange: function (e) { return update('emails', e.target.value); }, onFocus: inputFocus, onBlur: inputBlur }),
                            showError && formData.emails.trim() && !isValidEmailList(formData.emails) && (React.createElement("span", { style: { fontSize: '12px', color: '#ef4444', marginTop: '4px', display: 'block' } }, "Um ou mais e-mails informados s\u00E3o inv\u00E1lidos."))),
                        React.createElement("div", { style: S.group },
                            React.createElement("label", { style: S.label },
                                "Departamento(s) ",
                                React.createElement("span", { style: { color: '#ef4444' } }, "*")),
                            React.createElement("textarea", { style: __assign(__assign({}, S.textarea), { minHeight: '56px' }), rows: 2, placeholder: "Insira o(s) departamento(s)", value: formData.departments, onChange: function (e) { return update('departments', e.target.value); }, onFocus: inputFocus, onBlur: inputBlur })),
                        React.createElement("div", { style: S.group },
                            React.createElement("label", { style: S.label },
                                "Quais pastas ser\u00E3o acessadas na rede/nuvem? ",
                                React.createElement("span", { style: { color: '#ef4444' } }, "*")),
                            React.createElement("textarea", { style: __assign(__assign({}, S.textarea), { minHeight: '56px' }), rows: 2, placeholder: "Insira sua resposta", value: formData.folders, onChange: function (e) { return update('folders', e.target.value); }, onFocus: inputFocus, onBlur: inputBlur })),
                        ...
                        React.createElement("div", { style: S.group },
                            React.createElement("label", { style: S.label },
                                ...
                                React.createElement("span", { style: { color: '#ef4444' } }, "*")),
                            React.createElement("textarea", { style: __assign(__assign({}, S.textarea), { minHeight: '56px' }), rows: 2, placeholder: "Ex: Emissor de NF, Certificados digitais...", value: formData.programs, onChange: function (e) { return update('programs', e.target.value); }, onFocus: inputFocus, onBlur: inputBlur })),
                        React.createElement("div", { style: S.group },
                            React.createElement("label", { style: S.label }, "Quais impressoras ser\u00E3o utilizadas?"),
                            React.createElement("textarea", { style: __assign(__assign({}, S.textarea), { minHeight: '56px' }), rows: 2, placeholder: "Insira sua resposta", value: formData.printers, onChange: function (e) { return update('printers', e.target.value); }, onFocus: inputFocus, onBlur: inputBlur })),
                        React.createElement("div", { style: __assign(__assign({}, S.group), { background: theme.primaryLight, border: "1px solid ".concat(theme.primaryLighter), borderRadius: '10px', padding: '1rem' }) },
                            React.createElement("label", { style: __assign(__assign({}, S.label), { color: '#581c87' }) },
                                "Login de refer\u00EAncia ",
                                React.createElement("span", { style: { color: '#ef4444' } }, "*")),
                            ...
                            React.createElement("span", { style: __assign(__assign({}, S.helpText), { color: '#7e22ce', textTransform: 'uppercase', fontWeight: 600, letterSpacing: '0.3px' }) }, "Login de um colaborador no mesmo departamento para efeito de referenciamento.")))),
                    step === 4 && (React.createElement("div", null,
                        React.createElement("div", { style: { textAlign: 'center', marginBottom: '2rem' } },
                            ...
                            React.createElement("p", { style: __assign(__assign({}, S.sectionTitle), { textAlign: 'center' }) }, "Pronto para enviar!"),
                        ...
                        React.createElement("div", { style: __assign(__assign({}, S.alertBox), { marginTop: '1.5rem', borderLeftColor: theme.primary, background: theme.primaryLight }) },
                            React.createElement("span", { style: { fontSize: '22px', flexShrink: 0 } }, "\uD83D\uDCAC"),
                            React.createElement("div", null,
                                React.createElement("p", { style: __assign(__assign({}, S.alertTitle), { color: '#581c87' }) }, "N\u00E3o tem certeza sobre sua necessidade?"),
                                React.createElement("p", { style: __assign(__assign({}, S.alertText), { color: '#6b21a8' }) },
