...
function FormExclusao(_a) {
    ...
    var theme = formStyles_1.themes.exclusao;
    ...
    var updateExclusion = function (i, field, value) {
        var _a;
        var arr = tslib_1.__spreadArray([], formData.exclusions, true);
        arr[i] = tslib_1.__assign(tslib_1.__assign({}, arr[i]), (_a = {}, _a[field] = value, _a));
        setFormData(function (p) { return (tslib_1.__assign(tslib_1.__assign({}, p), { exclusions: arr })); });
        if (showError)
            setShowError(false);
    };
    var addExclusion = function () { return setFormData(function (p) { return (tslib_1.__assign(tslib_1.__assign({}, p), { exclusions: tslib_1.__spreadArray(tslib_1.__spreadArray([], p.exclusions, true), [{ tag: '', additionalInfo: '' }], false) })); }); };
    var removeExclusion = function (i) {
        if (formData.exclusions.length === 1)
            return;
        setFormData(function (p) { return (tslib_1.__assign(tslib_1.__assign({}, p), { exclusions: p.exclusions.filter(function (_, idx) { return idx !== i; }) })); });
    };
                ...
                React.createElement("div", { style: S.cardBody },
                    step === 1 && (React.createElement("div", null,
                        React.createElement("div", { style: S.alertBox },
                            ...
                            React.createElement("div", null,
                                ...
                                React.createElement("ul", { style: tslib_1.__assign(tslib_1.__assign({}, S.alertText), { paddingLeft: '1.25rem', marginTop: '8px' }) },
                    ...
                    step === 3 && (React.createElement("div", null,
                        ...
                        isLote ? (React.createElement(React.Fragment, null,
                            ...
                            loteMaquinas.map(function (m, i) { return (React.createElement("div", { key: "".concat(m.tag, "-").concat(i), style: tslib_1.__assign(tslib_1.__assign({}, S.itemCard), { borderColor: '#fecaca' }) },
                                React.createElement("div", { style: tslib_1.__assign(tslib_1.__assign({}, S.itemCardHeader), { background: '#fef2f2', color: '#991b1b' }) },
                                    React.createElement("span", null,
                                        "\uD83D\uDDA5 ",
                                        m.tag || 'Sem TAG',
                                        m.hostname ? " \u2014 ".concat(m.hostname) : '',
                                        m.departamento ? " (".concat(m.departamento, ")") : ''),
                                    loteMaquinas.length > 1 && (React.createElement("button", { onClick: function () { return removeLoteMaquina(i); }, style: tslib_1.__assign(tslib_1.__assign({}, S.iconBtn), { color: '#ef4444' }), title: "Remover" }, "\uD83D\uDDD1"))))); }))) : (React.createElement(React.Fragment, null,
                            formData.exclusions.map(function (exc, i) { return (React.createElement("div", { key: i, style: tslib_1.__assign(tslib_1.__assign({}, S.itemCard), { borderColor: '#fecaca' }) },
                                React.createElement("div", { style: tslib_1.__assign(tslib_1.__assign({}, S.itemCardHeader), { background: '#fef2f2', color: '#991b1b' }) },
                                    React.createElement("span", null,
                                        "\uD83D\uDDA5 Equipamento ",
                                        i + 1),
                                    formData.exclusions.length > 1 && (React.createElement("button", { onClick: function () { return removeExclusion(i); }, style: tslib_1.__assign(tslib_1.__assign({}, S.iconBtn), { color: '#ef4444' }), title: "Remover" }, "\uD83D\uDDD1"))),
                            ...
                            React.createElement("button", { style: tslib_1.__assign(tslib_1.__assign({}, S.btnAddMore), { borderColor: '#fca5a5', color: '#b91c1c' }), onClick: addExclusion }, "\uFF0B Adicionar outra m\u00E1quina para exclus\u00E3o"))))),
                    step === 4 && (React.createElement("div", null,
                        React.createElement("div", { style: { textAlign: 'center', marginBottom: '2rem' } },
                            ...
                            React.createElement("p", { style: tslib_1.__assign(tslib_1.__assign({}, S.sectionTitle), { textAlign: 'center' }) }, "Pronto para Solicitar Exclus\u00E3o!"),
                        ...
                        React.createElement("div", { style: S.reviewBox },
                            ...
                            React.createElement("div", { style: { background: '#fef2f2', padding: '10px 16px', borderBottom: '1px solid #fecaca' } },
                                React.createElement("span", { style: tslib_1.__assign(tslib_1.__assign({}, S.reviewLabel), { color: '#991b1b' }) },
