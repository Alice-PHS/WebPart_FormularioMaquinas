...
exports.default = FormSubstituicao;
...
function FormSubstituicao(_a) {
    ...
    var theme = formStyles_1.themes.substituicao;
    ...
    var _g = (0, react_1.useState)(isLote ? maquinas : []), loteMaquinas = _g[0], setLoteMaquinas = _g[1];
    var _h = (0, react_1.useState)(blankNewMachineShared()), loteNewMachine = _h[0], setLoteNewMachine = _h[1];
    ...
    var updateLoteNewUser = function (field, value) { return setLoteNewMachine(function (p) {
        var _a;
        return (tslib_1.__assign(tslib_1.__assign({}, p), { newUser: tslib_1.__assign(tslib_1.__assign({}, p.newUser), (_a = {}, _a[field] = value, _a)) }));
    }); };
    var updateLoteTransfer = function (field, value) { return setLoteNewMachine(function (p) {
        var _a;
        return (tslib_1.__assign(tslib_1.__assign({}, p), { transferDetails: tslib_1.__assign(tslib_1.__assign({}, p.transferDetails), (_a = {}, _a[field] = value, _a)) }));
    }); };
    var _j = (0, react_1.useState)({
        ...
        replacements: [tslib_1.__assign(tslib_1.__assign({}, blankReplacement()), { oldTag: tag || '', oldHostname: hostname || '', oldEquCodigo: equCodigo || '', oldDepartment: departamento || '' })],
    ...
    var updateRep = function (i, field, value) {
        var _a;
        var arr = tslib_1.__spreadArray([], formData.replacements, true);
        arr[i] = tslib_1.__assign(tslib_1.__assign({}, arr[i]), (_a = {}, _a[field] = value, _a));
        setFormData(function (p) { return (tslib_1.__assign(tslib_1.__assign({}, p), { replacements: arr })); });
    };
    var updateNewUser = function (i, field, value) {
        var _a;
        var arr = tslib_1.__spreadArray([], formData.replacements, true);
        arr[i] = tslib_1.__assign(tslib_1.__assign({}, arr[i]), { newUser: tslib_1.__assign(tslib_1.__assign({}, arr[i].newUser), (_a = {}, _a[field] = value, _a)) });
        setFormData(function (p) { return (tslib_1.__assign(tslib_1.__assign({}, p), { replacements: arr })); });
    };
    var updateTransfer = function (i, field, value) {
        var _a;
        var arr = tslib_1.__spreadArray([], formData.replacements, true);
        arr[i] = tslib_1.__assign(tslib_1.__assign({}, arr[i]), { transferDetails: tslib_1.__assign(tslib_1.__assign({}, arr[i].transferDetails), (_a = {}, _a[field] = value, _a)) });
        setFormData(function (p) { return (tslib_1.__assign(tslib_1.__assign({}, p), { replacements: arr })); });
    };
    var addReplacement = function () { return setFormData(function (p) { return (tslib_1.__assign(tslib_1.__assign({}, p), { replacements: tslib_1.__spreadArray(tslib_1.__spreadArray([], p.replacements, true), [blankReplacement()], false) })); }); };
    var removeReplacement = function (i) {
        if (formData.replacements.length === 1)
            return;
        setFormData(function (p) { return (tslib_1.__assign(tslib_1.__assign({}, p), { replacements: p.replacements.filter(function (_, idx) { return idx !== i; }) })); });
    };
    var validate = function (s) {
        ...
        if (s === 3)
            return isLote
                ? loteMaquinas.length > 0 && (loteNewMachine.sameUser || (loteNewMachine.newUser.name.trim() && loteNewMachine.newUser.email.trim() && (0, validation_1.isValidEmail)(loteNewMachine.newUser.email) && loteNewMachine.newUser.department.trim()))
                : formData.replacements.every(function (r) {
                    var oldOk = r.oldTag.trim() && r.oldEmail.trim() && (0, validation_1.isValidEmail)(r.oldEmail) && r.oldDepartment.trim();
                    var newOk = r.sameUser || (r.newUser.name.trim() && r.newUser.email.trim() && (0, validation_1.isValidEmail)(r.newUser.email) && r.newUser.department.trim());
                    return oldOk && newOk;
                });
        return true;
    };
                ...
                React.createElement("div", { style: S.cardBody },
                        ...
                        isLote ? (React.createElement(React.Fragment, null,
                            React.createElement("div", { style: { background: '#fff5f5', border: '1px solid #fecaca', borderRadius: '8px', padding: '1rem', marginBottom: '12px' } },
                                ...
                                loteMaquinas.map(function (m, i) { return (React.createElement("div", { key: "".concat(m.tag, "-").concat(i), style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: '#fff', border: '1px solid #fecaca', borderRadius: '8px', padding: '10px 14px', marginBottom: '8px' } },
                                    ...
                                    loteMaquinas.length > 1 && (React.createElement("button", { onClick: function () { return removeLoteMaquina(i); }, style: tslib_1.__assign(tslib_1.__assign({}, S.iconBtn), { color: '#ef4444' }), title: "Remover" }, "\uD83D\uDDD1")))); })),
                            ...
                            React.createElement("div", { style: { background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: '8px', padding: '1rem' } },
                                ...
                                React.createElement("div", { style: { background: '#fff', border: '1px solid #bbf7d0', borderRadius: '8px', padding: '1rem', marginBottom: '10px' } },
                                    React.createElement("label", { style: tslib_1.__assign(tslib_1.__assign({}, S.label), { marginBottom: '10px' }) },
                                        ...
                                        React.createElement("div", { style: S.grid3 },
                                            ...
                                            React.createElement("div", null,
                                                React.createElement("label", { style: S.label },
                                                    "Novo E-mail ",
                                                    React.createElement("span", { style: { color: '#ef4444' } }, "*")),
                                                React.createElement("input", { style: tslib_1.__assign(tslib_1.__assign({}, S.input), { borderColor: showError && loteNewMachine.newUser.email.trim() && !(0, validation_1.isValidEmail)(loteNewMachine.newUser.email) ? '#ef4444' : undefined }), type: "email", value: loteNewMachine.newUser.email, onChange: function (e) { return updateLoteNewUser('email', e.target.value); }, onFocus: inputFocus, onBlur: inputBlur }),
                                                showError && loteNewMachine.newUser.email.trim() && !(0, validation_1.isValidEmail)(loteNewMachine.newUser.email) && (React.createElement("span", { style: { fontSize: '12px', color: '#ef4444', marginTop: '4px', display: 'block' } }, "E-mail inv\u00E1lido."))),
                                            React.createElement("div", null,
                                                React.createElement("label", { style: S.label },
                                                    "Novo Departamento ",
                                                    React.createElement("span", { style: { color: '#ef4444' } }, "*")),
                                    ...
                                    loteNewMachine.needsTransfer && (React.createElement("div", { style: { paddingTop: '12px', borderTop: '1px solid #e2e8f0' } },
                                        React.createElement("div", { style: S.grid2 },
                                            React.createElement("div", null,
                                                ...
                                                React.createElement("textarea", { style: tslib_1.__assign(tslib_1.__assign({}, S.textarea), { minHeight: '56px' }), rows: 2, placeholder: "Ex: C:\\Sistemas, Meus Documentos...", value: loteNewMachine.transferDetails.files, onChange: function (e) { return updateLoteTransfer('files', e.target.value); }, onFocus: inputFocus, onBlur: inputBlur })),
                                            React.createElement("div", null,
                            ...
                            formData.replacements.map(function (rep, i) { return (React.createElement("div", { key: i, style: S.itemCard },
                                React.createElement("div", { style: S.itemCardHeader },
                                    React.createElement("span", null,
                                        ...
                                        i + 1),
                                    formData.replacements.length > 1 && (React.createElement("button", { onClick: function () { return removeReplacement(i); }, style: tslib_1.__assign(tslib_1.__assign({}, S.iconBtn), { color: '#ef4444' }) }, "\uD83D\uDDD1"))),
                                        ...
                                        React.createElement("div", { style: S.grid3 },
                                            ...
                                            React.createElement("div", null,
                                                React.createElement("label", { style: S.label },
                                                    "E-mail do usu\u00E1rio ",
                                                    React.createElement("span", { style: { color: '#ef4444' } }, "*")),
                                                React.createElement("input", { style: tslib_1.__assign(tslib_1.__assign({}, S.input), { borderColor: showError && rep.oldEmail.trim() && !(0, validation_1.isValidEmail)(rep.oldEmail) ? '#ef4444' : undefined }), type: "email", placeholder: "usuario@empresa.com", value: rep.oldEmail, onChange: function (e) { return updateRep(i, 'oldEmail', e.target.value); }, onFocus: inputFocus, onBlur: inputBlur }),
                                                showError && rep.oldEmail.trim() && !(0, validation_1.isValidEmail)(rep.oldEmail) && (React.createElement("span", { style: { fontSize: '12px', color: '#ef4444', marginTop: '4px', display: 'block' } }, "E-mail inv\u00E1lido."))),
                                            React.createElement("div", null,
                                                React.createElement("label", { style: S.label },
                                                    "Departamento ",
                                                    React.createElement("span", { style: { color: '#ef4444' } }, "*")),
                                                ...
                                                React.createElement("div", { style: S.grid3 },
                                                    ...
                                                    React.createElement("div", null,
                                                        React.createElement("label", { style: S.label },
                                                            "Novo E-mail ",
                                                            React.createElement("span", { style: { color: '#ef4444' } }, "*")),
                                                        React.createElement("input", { style: tslib_1.__assign(tslib_1.__assign({}, S.input), { borderColor: showError && rep.newUser.email.trim() && !(0, validation_1.isValidEmail)(rep.newUser.email) ? '#ef4444' : undefined }), type: "email", value: rep.newUser.email, onChange: function (e) { return updateNewUser(i, 'email', e.target.value); }, onFocus: inputFocus, onBlur: inputBlur }),
                                                        showError && rep.newUser.email.trim() && !(0, validation_1.isValidEmail)(rep.newUser.email) && (React.createElement("span", { style: { fontSize: '12px', color: '#ef4444', marginTop: '4px', display: 'block' } }, "E-mail inv\u00E1lido."))),
                                                    React.createElement("div", null,
                                                        React.createElement("label", { style: S.label },
                                                            "Novo Departamento ",
                                                            React.createElement("span", { style: { color: '#ef4444' } }, "*")),
                                        ...
                                        React.createElement("div", { style: { background: '#fff', border: '1px solid #bbf7d0', borderRadius: '8px', padding: '1rem' } },
                                            ...
                                            rep.needsTransfer && (React.createElement("div", { style: { paddingTop: '12px', borderTop: '1px solid #e2e8f0' } },
                                                React.createElement("div", { style: S.grid2 },
                                                    React.createElement("div", null,
                                                        React.createElement("label", { style: S.label }, "Pastas / Arquivos espec\u00EDficos"),
                                                        React.createElement("textarea", { style: tslib_1.__assign(tslib_1.__assign({}, S.textarea), { minHeight: '56px' }), rows: 2, placeholder: "Ex: C:\\Sistemas, Meus Documentos...", value: rep.transferDetails.files, onChange: function (e) { return updateTransfer(i, 'files', e.target.value); }, onFocus: inputFocus, onBlur: inputBlur })),
                                                    React.createElement("div", null,
                                                        React.createElement("label", { style: S.label }, "Softwares / Configura\u00E7\u00F5es"),
                                                        React.createElement("textarea", { style: tslib_1.__assign(tslib_1.__assign({}, S.textarea), { minHeight: '56px' }), rows: 2, placeholder: "Ex: Certificados, Favoritos Chrome...", value: rep.transferDetails.programs, onChange: function (e) { return updateTransfer(i, 'programs', e.target.value); }, onFocus: inputFocus, onBlur: inputBlur })))))))))); }),
                    ...
                    step === 4 && (React.createElement("div", null,
                        React.createElement("div", { style: { textAlign: 'center', marginBottom: '2rem' } },
                            ...
                            React.createElement("p", { style: tslib_1.__assign(tslib_1.__assign({}, S.sectionTitle), { textAlign: 'center' }) }, "Pronto para Solicitar Substitui\u00E7\u00E3o!"),
                            ...
                            isLote
                                ? loteMaquinas.map(function (m, i) { return (React.createElement("div", { key: "".concat(m.tag, "-").concat(i), style: { padding: '12px 16px', borderBottom: '1px solid #f1f5f9', display: 'flex', gap: '24px', alignItems: 'center' } },
                                    React.createElement("div", { style: { flex: 1 } },
                                        React.createElement("span", { style: tslib_1.__assign(tslib_1.__assign({}, S.reviewLabel), { color: '#dc2626' }) }, "Sai"),
                                    ...
                                    React.createElement("div", { style: { flex: 1 } },
                                        React.createElement("span", { style: tslib_1.__assign(tslib_1.__assign({}, S.reviewLabel), { color: '#16a34a' }) }, "Entra"),
